		...
		<div class="col-12">
			<div class="card">
				...
				<div class="p-fluid formgrid grid">
					<div class="field col-12 md:col-4">
						<label for="state">Category (If is_leaf yes)</label>
						<Dropdown id="state" :filter="true" v-model="leafCategory" :options="leafCategories"
							optionLabel="name" placeholder="Select One">
						</Dropdown>
					</div>

					<div class="field col-12 md:col-4">
						<label for="state">UI</label>
			...
			<div class="card">
				...
				<DataTable :value="categoryUis" :paginator="true" class="p-datatable-gridlines" :rows="10" dataKey="id"
					...
					<Column field="category_type" header="Category Type" style="min-width:12rem">
						<template #body="{ data }">
							{{ data.category_type }}
						</template>
					</Column>
