...
<script>
	...
	import { listboxValues1,dropdownValues,multiselectValues1,selectButtonValues1,selectButtonValues2 } from '../storejson/storejson';
	...
	export default {
		data() {
			return {
				...
				checkboxValue: [],
				switchValue: false,
				listboxValues: listboxValues1,
				listboxValue: null,
				dropdownValues:dropdownValues,
				dropdownValue: null,
				multiselectValue: null,
				multiselectValues:multiselectValues1,
				toggleValue: false,
				selectButtonValues1: selectButtonValues1,
				selectButtonValue1: null,
				selectButtonValues2: selectButtonValues2,
