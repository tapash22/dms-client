		...
		<div class="col-12">
			<div class="card">
				...
				<div class="p-fluid formgrid grid">
					<div class="field col-12 md:col-4">
						<label for="firstname2">User Group</label>
			...
			<div class="card">
				...
				<DataTable :value="categoryTypes" :paginator="true" class="p-datatable-gridlines" :rows="10" dataKey="id" :rowHover="true" 
                    ...
                    <Column field="name" header="User Group" style="min-width:12rem">
                        <template #body="{data}">
                            {{data.name}}
                        </template>
...
import { dropdownItems,categoryTypes1 } from '../storejson/storejson'
...
export default {
	...
	mounted() {
		this.categoryTypes = categoryTypes1;
			this.loading1 = false
	},
	methods: {
		initFilters1() {
