...
<DocumentDetailCard1 name="Name" customer="Custom Attributes" metaFields="metaFields"  />
<DocumentDetailCard1 customer="Custom Attributes" metaFields="metaFields"  />
...
import { statuses,metaFields,folders } from '../storejson/storejson'
import DocumentDetailCard1 from "./card/DocumentDetailCard1.vue";
...
export default {
  ...
  mounted() {
    ...
    this.breadcrumbItems = [
      ...
      { label: "Shared with Me", slug: "dhaka" },
    ];
    this.loading1 = false;
  },
  methods: {
